...
type paymentItem struct {
	...
	PgID            int       `orm:"column(PgID);;null" json:"pgid"`               // payment_category.category_cid 100번대 일 경우 셋팅 됨. payment_gateway.pg_id
	...
	CloseAt         time.Time `orm:"type(datetime);" json:"close_at"`              //
}
